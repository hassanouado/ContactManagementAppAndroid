...
public class AddEditContact extends AppCompatActivity {
    ...
    private EditText firstname,lastname,phoneEt,emailEt,villeEt,jobEt;
    RadioGroup radioGroup;
    private FloatingActionButton fab;String url = "http://192.168.56.1:8082/";
    Long id;
    //String variable;
    private String image,firstName,lastName,phone,email,ville,job;
...
//       ContentValues for image info
    ...
    private void saveData() {
        ...
        //check filed data
        if (!firstName.isEmpty() || !phone.isEmpty() || !email.isEmpty() || !lastName.isEmpty()|| !job.isEmpty()|| !ville.isEmpty()){
            //save data ,if user have only one data
            Retrofit retrofit = new Retrofit.Builder( ).baseUrl(url).addConverterFactory(GsonConverterFactory.create( )).build( );
            ContactService api = retrofit.create(ContactService.class);
            Contact c=new Contact(0,firstName,lastName,email,phone,job,ville);
